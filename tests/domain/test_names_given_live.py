...
class TestTheNameIsCarriedOver:
    def test_a_voice_a_human_named_takes_the_name(self):
        found = from_live([named(0, 100, "Kevin")], [turn(0, 100, "26")])
        assert found == {"26": "Kevin"}
...
class TestWhatIsNotCarriedOver:
    ...
    def test_two_people_crossing_one_voice_name_it_neither(self):
        ...
        worse than none."""
        found = from_live(
            [named(0, 50, "Kevin"), named(50, 100, "Camilo")],
            [turn(0, 100, "26")],
        )
        assert found == {}
    ...
    def test_a_clear_winner_still_wins(self):
        found = from_live(
            [named(0, 90, "Kevin"), named(90, 100, "Camilo")],
            [turn(0, 100, "26")],
        )
        assert found == {"26": "Kevin"}
    ...
    def test_the_share_is_what_it_says(self):
        ...
        assert from_live([named(0, court, "Kevin")], [turn(0, 100, "26")]) == {}
        large = SHARE_TO_CARRY * 100 + 1
        assert from_live([named(0, large, "Kevin")], [turn(0, 100, "26")]) == {
            "26": "Kevin"}

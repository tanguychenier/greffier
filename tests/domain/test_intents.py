...
class TestWhatIsUnderstood:
    ...
    def test_a_surname_and_a_first_name(self):
        appris = understand("retiens que Paul Bizouard est développeur")
        assert appris is not None
        assert appris.subject == "Paul Bizouard"
...
class TestTheConfirmation:
    ...
    def test_it_tells_a_person_apart(self):
        sentence = understand("note que Morgane est cheffe de projet").say()

...
ORDINAIRE = """Fantin : le déploiement en préproduction s'est bien passé vendredi.
Tanguy : j'ai relu la documentation, elle est à jour.
Fantin : très bien. On enchaîne sur le point suivant.
Tanguy : d'accord.
"""

SANS_RESPONSABLE = """Fantin : donc on est d'accord, on migre la base en Symfony 7
avant la recette.
Tanguy : oui, c'est acté.
Fantin : parfait. Sujet suivant, les congés d'août.
"""

QUESTION_EN_L_AIR = """Tanguy : est-ce que quelqu'un sait si les flux sont ouverts
vers la pré-prod de Saclay ?
Fantin : bon, sinon, il faut qu'on parle du budget du trimestre.

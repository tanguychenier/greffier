...
def empreintes_intruses(
    ...
    empreinte de Kevin qui ressemble à 0,78 à Paul et à 0,55 au reste de Kevin
    n'est pas de Kevin.

    Mesuré sur la banque de ce poste : deux des trois empreintes de « Kevin »
    et deux des quatre de « Paul » désignaient quelqu'un d'autre, ce que le
